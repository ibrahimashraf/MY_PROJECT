...
*   [ ] **3.1: ISO 17020 Section 6.2 Calibrated Tool Registry (`internal/shared/calibration/`, `internal/platform/calibration/`, `migrations/0073_*`)** (gate re-opened 2026-09-08 — wiring gap, see below):
