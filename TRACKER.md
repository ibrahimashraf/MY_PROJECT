...
* [x] **Stage D: Bounded Intelligence & Advisory Extractors (`internal/advisory/extractor.go`, `internal/advisoryhttp/`)** — COMPLETE ✅ (2026-09-15, delegated `opencode/big-pickle`):
    ...
    *   Quality gates: 0 warnings from `go vet`, 53/53 tests PASS across `internal/advisory` and `internal/advisoryhttp`.
