...
CREATE INDEX IF NOT EXISTS bulk_import_job_scope_status_idx ON bulk_import_job (tenant_id, organization_id, status, created_at DESC);
CREATE INDEX IF NOT EXISTS bulk_import_row_job_idx ON bulk_import_row (job_id, row_num);
CREATE INDEX IF NOT EXISTS bulk_export_job_scope_status_idx ON bulk_export_job (tenant_id, organization_id, status, created_at DESC);
